...
/**
 * Based on https://github.com/lzyzsd/CircleProgress/blob/master/library/src/main/java/com/github/lzyzsd/circleprogress/ArcProgress.java
 * and modified to show the number of completed products vs all products instead of the percentage
 */
class ArcProgress @JvmOverloads constructor(
    ...
    protected fun initByAttributes(attributes: TypedArray) {
        ...
        setProgress(attributes.getInt(R.styleable.ArcProgress_progress, 0))
        strokeWidth =
    ...
    //@BindingAdapter("app:arc_max")
    //fun setMax(view: View, max: Int) {
    //    this.max = max
    //}

    //@BindingAdapter("app:arc_progress")
    ...
    private fun dp2px(resources: Resources, dp: Int): Float {
        val scale: Float = resources.displayMetrics.density
        return dp * scale + 0.5f
    }

    private fun sp2px(resources: Resources, sp: Int): Float {
